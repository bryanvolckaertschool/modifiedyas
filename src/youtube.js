...
const cache = {}
var YoTube = require('../node_modules/youtube-node/lib/youtube');


var yoTube = new YoTube();
...
class YouTube {
  ...
  search ({ query, page }, callback) {
    yoTube.setKey('AIzaSyBzJklLJPatVT3d_Sa8Ao1XsmpQVb4Eqgw');
    yoTube.search(query, 2, callback);
    
  }

  get (id, callback) {
    yoTube.setKey('AIzaSyBzJklLJPatVT3d_Sa8Ao1XsmpQVb4Eqgw');
    yoTube.getById(id, callback)
  }
}
